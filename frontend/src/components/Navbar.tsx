...
import { FinancialOfficerInterface } from "../models/IFinancialOfficer";
...
function Navbar() {
 ...
 const requestOptions = {
  ...
  const [financialofficer, setFinancialOfficers] = useState<FinancialOfficerInterface>();
      ...
      >
        <Toolbar>
          ...
          <Typography variant="subtitle1" >
            {financialofficer?.FinancialName} &nbsp;&nbsp;
          </Typography>
